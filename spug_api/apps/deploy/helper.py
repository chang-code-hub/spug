...
class Helper:
    ...
    def local(self, command, env=None):
        ...
        exec_command = f'''
[ -f /root/command.sh ] && . /root/command.sh
{command}
        '''
        task = subprocess.Popen(exec_command, env=env, shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, executable='/bin/bash')
        message = b''
        while True:
